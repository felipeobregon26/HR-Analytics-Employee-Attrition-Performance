...
Se eliminan tres variables de varianza cero (`EmployeeCount`, `Over18`, `StandardHours`) 
por no aportar poder discriminatorio al modelo. La variable `Gender` — aunque constante
en este dataset — se reporta como hallazgo organizacional en la
sección de limitaciones: un dataset sin diversidad de género restringe
